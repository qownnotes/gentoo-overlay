...
SRC_URI="https://github.com/pbek/QOwnNotes/releases/download/v25.5.6/${P}.tar.xz"
...
src_install() {
	...
	dodir /usr/share/QOwnNotes/translations
	insinto /usr/share/QOwnNotes/translations
